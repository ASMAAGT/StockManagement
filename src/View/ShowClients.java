 ...
 * @author Iyed
 */
public class ShowClients extends javax.swing.JInternalFrame {
    ...
    public ShowClients() {
       ...
       ArrayList<Client>  myclientlist = new ClientController().retrieveAll();
        ...
        model.addColumn("IdCl");
        model.addColumn("NameCl");
        model.addColumn("PhoneCl");
    ...
    private void initComponents() {
        ...
        TxtPhoneCl = new javax.swing.JTextField();
        ...
        AddButn.setText("Add New Client");
        ...
        DeleteButn.setText("Delete Client");
        ...
        ModifyButn.setText("Modify Client");
        ...
        TxtIdCl.setFont(new java.awt.Font("Bell MT", 0, 18)); // NOI18N
        TxtIdCl.setForeground(new java.awt.Color(204, 0, 102));
        TxtIdCl.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TxtIdClActionPerformed(evt);
            }
        });
        kGradientPanel2.add(TxtIdCl, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 260, 30));
        ...
        TxtPhoneCl.setFont(new java.awt.Font("Bell MT", 0, 18)); // NOI18N
        TxtPhoneCl.setForeground(new java.awt.Color(204, 0, 102));
        TxtPhoneCl.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TxtPhoneClActionPerformed(evt);
            }
        });
        kGradientPanel2.add(TxtPhoneCl, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, 260, 30));
        ...
        TxtNameCl.setFont(new java.awt.Font("Bell MT", 0, 18)); // NOI18N
        TxtNameCl.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TxtNameClActionPerformed(evt);
            }
        });
        kGradientPanel2.add(TxtNameCl, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 260, 30));
    ...
    String keyword= Txtsearch.getText();
        ArrayList<Client>  myclientlist = new ClientController().retrieveByKeyWord(keyword);
        DefaultTableModel model = new DefaultTableModel() ;
        jTable1.setModel(model) ; 
        model.addColumn("IdCl");
        model.addColumn("NameCl");
    ...
    private void AddButnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButnActionPerformed
        ...
        client.setNameCl(TxtNameCl.getText());
        client.setPhoneCl(Integer.valueOf(TxtPhoneCl.getText()));
      
 
        boolean result = new ClientController().create(client);
        
         if(result){              
            JOptionPane.showMessageDialog(this,
            client.getNameCl().toUpperCase()+" Is successfuly added  ",
            "New Client", JOptionPane.INFORMATION_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this,
            "Ajout erronée ",
            "Nouveau Client", JOptionPane.ERROR_MESSAGE);
        }
         refresh();}
        ...
        if(x == -1){
            ...
            "Information Message", JOptionPane.INFORMATION_MESSAGE);
                    ...
                    jTable1.setModel(model);
                      ...
                      JOptionPane.showMessageDialog(this,
            "Client not Deleted check with the administrator!",
    ...
    private void ModifyButnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModifyButnActionPerformed
        ...
        boolean result = new ClientController().update(id, client);
        
         if(result){              
            JOptionPane.showMessageDialog(this,
            client.getNameCl().toUpperCase()+" est modifié avec success ",
            ...
            "Modifier client", JOptionPane.ERROR_MESSAGE);
        }
         refresh();}
    ...
    private void TxtPhoneClActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TxtPhoneClActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TxtPhoneClActionPerformed

    private void TxtNameClActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TxtNameClActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TxtNameClActionPerformed
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(x == -1){
            ...
            "Information Message", JOptionPane.INFORMATION_MESSAGE);
                ...
                int PhoneCl = Integer.parseInt(""+jTable1.getValueAt(x, 2));
              
                 TxtIdCl.setText(String.valueOf(id));
                 TxtIdCl.setEnabled(false);
                 TxtNameCl.setText(NameCl);
                 TxtPhoneCl.setText(String.valueOf(PhoneCl));
    ...
    private javax.swing.JTextField TxtPhoneCl;
